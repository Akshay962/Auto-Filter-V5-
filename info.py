...
BOT_TOKEN = environ.get('BOT_TOKEN', "5568521536:AAGpAhfAiViulNM84n5BH_SVAM4SnepwOfE")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001620890417').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Alita:123@cluster0.rjdxvap.mongodb.net/?retryWrites=true&w=majority")
...
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001620890417))
...
# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001871394819))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001871394819))
